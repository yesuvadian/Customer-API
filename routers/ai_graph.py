...
def get_overview(
    ...
    ea_list: list[EquipmentAnalytics] = _scoped_ea(department_id, db, organization_id=user.get("organization_id"))
...
def get_life_left(
    ...
    """
    ea_list = _scoped_ea(department_id, db, organization_id=user.get("organization_id"))
