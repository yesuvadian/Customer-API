"""
Check if orgadmin@sampleorg.com exists and has organization_id set
"""
import os
import sys
...
try:
    ...
    with engine.connect() as conn:
        print("="*80)
        print("Checking orgadmin@sampleorg.com user...")
        print("="*80)
        ...
        result = conn.execute(text("""
            SELECT
                ...
                email_confirmed
            FROM users
            WHERE email = 'orgadmin@sampleorg.com'
        """))
